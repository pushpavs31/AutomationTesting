...
Alert alert;
	...
	{
		Utilities.waitForElement(cartItem, 10, driver);
		cartItem.click();
	...
	public void enterQuantityOfRuby(String num)
	{
		productTypeField.clear();
		Utilities.waitForElement(productTypeField, 5, driver);
		productTypeField.sendKeys(num);
	}
